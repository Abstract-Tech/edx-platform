...
from .views import CourseDetailView, CourseIdListView, CourseListView, LatestCourseListView

urlpatterns = [
    path('v1/courses/', CourseListView.as_view(), name="course-list"),
    path('v1/courses/latest/', LatestCourseListView.as_view(), name="latest-course-list"),
